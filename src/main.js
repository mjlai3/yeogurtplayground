...
var _subscribe = require('../_modules/subscribe/subscribe');
  ...
  var gridCount = $(".grid").children('.grid-item').length;
	...
	grid.infinitescroll({
		...
		errorCallback: function () {
		        ...
		        $("<div class=\"article__more__container\"></div>").insertAfter('.grid');
		},

		//path: ["/api/sitecore/Home/getarticles?count=", ""]
		path: function path(pageNumber) {
			var pillar = window.location.pathname.split("/");
			if (pillar[2] == "") return moreUrl + "?count=" + pageNumber;else if(pillar[1] == "search") return moreUrl + "&count=" + pageNumber;else if (pillar[3] == "") return moreUrl + "?pillar=" + pillar[2] + "&count=" + pageNumber;else return moreUrl + "?pillar=" + pillar[2] + "&subcategory=" + pillar[3] + "&count=" + pageNumber;
		}
	},
	...
	$(".filter__checkbox").change(function () {
		...
		var count = 0;
		$.each($('.grid .grid-item:visible'), function () {
		    count++;
		});
		if (count < 10) {
		    $('.grid').infinitescroll('retrieve');
